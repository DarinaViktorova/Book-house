...
@TestPropertySource("classpath:hibernate-testdb.yml")
...
private final Environment env;
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("ua.house.book.creditcardservice.domain.entity");
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl(env.getProperty("hibernate.connection.url", "jdbc:mysql://localhost:3310/test_book_house_credit_card"));
