...
public class HibernateConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("ua.book.house.auth.domain.entity");
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl(env.getProperty("hibernate.connection.url", "jdbc:mysql://localhost:3308/book_house_auth"));
