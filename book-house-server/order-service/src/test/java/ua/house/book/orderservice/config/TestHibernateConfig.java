...
public class TestHibernateConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("ua.house.book.orderservice.domain.entity");
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl(env.getProperty("hibernate.connection.url", "jdbc:mysql://localhost:3311/test_book_house_order"));
