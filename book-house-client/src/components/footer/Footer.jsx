					...
					<Col lg="3" md="4" sm="6">
						<div className="logo__container">
							...
							<p>
								...
								reprehenderit dicta quis dolorem quibusdam officia amet iste qui
								cupiditate debitis harum fuga corporis repudiandae ipsam, vero
								cumque sint sunt expedita.
							</p>
						</div>
					</Col>
